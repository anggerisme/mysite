...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.13.0"}`, params.application, params.integration, params.feature);
...
function wrapAppDefinition(makeRequest, data) {
  ...
  const appDefinitionWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(appDefinition, createAppDefinitionApi(makeRequest));
